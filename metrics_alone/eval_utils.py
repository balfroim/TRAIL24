"""This file comes from https://github.com/explainablerecsys/ecir2024/tree/main/Hands-On with only adjustments
 to make the paths work in the main directory."""
...
from metrics_alone.utils import check_dir

from metrics_alone.data_utils import get_set, get_user_negatives, get_user_positives
from tqdm import tqdm
from metrics_alone.utility_metrics import NDCG, MRR, PRECISION, RECALL
from metrics_alone.beyond_accuracy_metrics import SERENDIPITY, DIVERSITY, NOVELTY
